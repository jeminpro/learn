...
* Percent means “**per hundred**”, so 20% = $\tfrac{20}{100}$ = 0.2
...
1. Convert $\tfrac{1}{2}$ → 0.5 → 50%
2. Convert 0.25 → 25%
3. Convert $\tfrac{3}{5}$ → 0.6 → 60%
4. Convert 0.75 → 75% → $\tfrac{3}{4}$
5. Convert 30% → $\tfrac{30}{100}$ → $\tfrac{3}{10}$
...
2. Convert $\tfrac{1}{4}$ to a percentage
3. What is 0.8 as a percentage?
4. Write 0.3 as a fraction
5. Convert $\tfrac{3}{10}$ to a percentage
6. What is 25% as a fraction?
7. Convert $\tfrac{2}{5}$ to a decimal
8. What is 50% as a decimal?
9. Write 0.2 as a fraction
10. Convert $\tfrac{1}{10}$ to a percentage

#### 🔸 Medium

11. Convert $\tfrac{3}{4}$ to a decimal and a percentage
12. Write 0.6 as a percentage and fraction
13. Convert 40% to a decimal and fraction
14. Convert $\tfrac{5}{8}$ to a percentage
15. Write 0.9 as a fraction and percentage
16. Convert $\tfrac{7}{10}$ to percentage
17. Write 35% as a fraction
18. Convert $\tfrac{4}{5}$ to a decimal and percent
19. Write 0.125 as a fraction
20. Convert $\tfrac{3}{20}$ to percentage

#### 🔺 Hard

21. Convert $\tfrac{11}{20}$ to decimal and percentage
22. A test score is $\tfrac{17}{25}$. What is the percentage?
23. Convert $\tfrac{7}{8}$ to a decimal and percent
24. A number is 0.375. Write it as a fraction and percent
25. 56% as a decimal and simplified fraction
26. Convert $\tfrac{13}{16}$ to percent
27. A student answered $\tfrac{18}{24}$ correctly. What percent is that?
28. Convert $\tfrac{9}{40}$ to percent
...
24. $\tfrac{3}{8}$ and 37.5%

25. 0.56 and $\tfrac{14}{25}$
...
29. $\tfrac{2}{3}$ and 66.6%

30. $\tfrac{7}{8}$ and 0.875
